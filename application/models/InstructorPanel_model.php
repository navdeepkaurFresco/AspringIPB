...
class InstructorPanel_model extends CI_Model {
	...
	*/
	...
	public function get_single_course_students_list()
	{
		$query = $this->db->select('td.*,ud.fullname, ud.email, ud.phone, ud.address')
		->join('users_details as ud','ud.id=td.user_id','LEFT')
		->get_where('transaction_details as td',array('td.complete_package'=>'0'));
	...
	*/
	...
	public function get_single_course_students_result()
	{
		$query = $this->db->select('td.*,ud.fullname, ud.email, ud.phone, ud.address')
		->join('users_details as ud','ud.id=td.user_id','LEFT')
		->get_where('transaction_details as td',array('td.complete_package'=>'0'));
