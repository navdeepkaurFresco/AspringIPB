                        ...
                        {?>  
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a class="btn  btn-outline-info block btn-sm round" href="<?php echo base_url("uploads/").$row['file_url']; ?>" style='width: 70% !important;' download><i class="ft ft-download"></i>Download</a></td>
                            </tr>
                            <?php $i++; }?>
                          </tbody>
                        </table>
