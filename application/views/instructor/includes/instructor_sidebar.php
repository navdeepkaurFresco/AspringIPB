  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" >
      ...
      <li class="nav-item <?php echo ($this->uri->segment(2)=='complete-package') ? 'active open' : '' ?>">
          ...
          <ul class="menu-content">
              <li class="menu-item <?php echo ($this->uri->segment(1) == 'instructor' && $this->uri->segment(2) == 'single-course' && $this->uri->segment(3) == 'list') ? 'active' : '' ?>">
                  <a href="<?php echo base_url('instructor/single-course/list'); ?>" >Students Who Bought</a>
              </li>
              <li class="menu-item <?php echo ($this->uri->segment(1) == 'instructor' && $this->uri->segment(2) == 'single-course' && $this->uri->segment(3) == 'result') ? 'active' : '' ?>">
                  <a href="<?php echo base_url('instructor/single-course/result'); ?>" >Students who Completed</a>
              </li>
          </ul>
      </li>
