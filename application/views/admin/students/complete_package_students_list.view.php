  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Students Who bought Complete Package</h3>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <a href="">Complete Package Details</a>
              </li>
              <li class="breadcrumb-item active">
                Students Who bought Complete Package
              </li>
            </ol>
          </div>
        </div>
...
<script src="<?php echo base_url();?><?php echo base_url();?>/app-assets/vendors/js/tables/datatable/dataTables.select.min.js" type="text/javascript"></script>
