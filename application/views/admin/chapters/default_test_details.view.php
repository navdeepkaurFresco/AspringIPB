      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Chapter Test Default Settings</h3>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-content">
                    ...
                    <?php } ?>
                    <div class="card-body">
                      <?php echo form_open('chapter/test/details','novalidate');?>
                        <div class="form-body">
                          <h4 class="form-section"><i class="la la-eye"></i> Chapter Test Default Settings</h4>
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <h5>No. Of Questions<span class="required">*</span></h5>
                                <div class="controls">
                                  <input type="number" min="1" id="no_of_questions" name="no_of_questions" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $default_settings['no_of_questions']; ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="number" min="1" id="test_time" name="test_time" class="form-control" value="<?php echo $default_settings['test_time']; ?>" required data-validation-required-message="This field is required">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <input type="number" min="1" id="per_question_marks" name="per_question_marks"value="<?php echo $default_settings['per_question_marks']; ?>" class="form-control" required data-validation-required-message="This field is required">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <input type="number" min="1" id="test_attempts" name="test_attempts" class="form-control" value="<?php echo $default_settings['test_attempts']; ?>" required data-validation-required-message="This field is required">
                                </div>
                              </div>
                            </div>
                          </div>
