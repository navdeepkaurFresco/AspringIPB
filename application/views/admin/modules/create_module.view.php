      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Create New Module</h3>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-content">
                    <div class="card-body">
                      <?php echo form_open_multipart('module/create','novalidate');?>
                        <div class="form-body">
                          <h4 class="form-section"><i class="la la-eye"></i> Module Details</h4>
                          <!--1nd row--> 
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <select name="instructor_id" id="instructor_id" class="form-control" required data-validation-required-message="This field is required">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <input type="text" id="course_title" name="course_title" class="form-control" placeholder="Enter Module Title" required data-validation-required-message="This field is required">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class='input-group'>
                                  <input type='number' id="time_duration" name="time_duration" class="form-control" min="1" required data-validation-required-message="This field is required"/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <input type="number" id="fee" name="fee" min="1" class="form-control" placeholder="Enter Module Fee" min="0" required data-validation-required-message="This field is required">
                                </div>
                              </div>
                              <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                  <textarea rows="12" class="form-control" type="textarea" id="brief_detail" name="brief_detail" placeholder="Tell something about Module" required data-validation-required-message="This field is required"></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="form-actions right">
                            ...
                            <button type="submit" name="create_Module" value="submit" class="btn btn-primary">
