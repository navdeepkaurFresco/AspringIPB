...
<body class="vertical-layout vertical-compact-menu 2-columns menu-expanded fixed-navbar superadmin-body" data-open="click" data-menu="vertical-compact-menu" data-col="2-columns">
<?php include(dirname(__FILE__)."/includes/header.php"); ?>
<!-- ////////////////////////////////////////////////////////////////////////////-->
<?php include(dirname(__FILE__)."/includes/sidebar.php"); ?>
<div class="app-content content super">
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">Super Admin Profile</h3>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <?php if($this->session->flashdata('item_update_adminDetail')) {
                    $message = $this->session->flashdata('item_update_adminDetail'); ?>
                  ...
                  <div class="nav-vertical">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" id="baseVerticalLeft1-tab1" data-toggle="tab" aria-controls="tabVerticalLeft11"
                          ...
                          <div class="text-center">
                            <div class="card-body">
                              <img src="<?php echo base_url('uploads/').$LoginUserDetails['profile_image'] ; ?>" class=""
                                alt="Card image">
                            </div>
                            <div class="card-body">
                              <h4 class="card-title"><?php echo $LoginUserDetails['fullname']; ?></h4>
                              <h6 class="card-subtitle text-muted">
                                <?php if($LoginUserDetails['user_type'] == '0'){ echo "SuperAdmin"; }
                                elseif($LoginUserDetails['user_type'] == '1'){ echo "Instructor"; }
                                elseif($LoginUserDetails['user_type'] == '2'){ echo "Student"; } ?></h6>
                              <h4 class="card-title"><?php echo $LoginUserDetails['designation']; ?></h4>
                            </div>
                          </div>
                        </a>
                      </li>
                    ...
                    <div class="tab-content px-1">
                          ...
                          <div id="fuzzy-search-list" class="row info-div-content">
                            ...
                            <ul class="list-group list col-md-6">
                              ...
                              <li class="list-group-item">
                                ...
                                <span class="info-value"><?php $dob = $LoginUserDetails['dob']; echo ($dob=='0000-00-00') ? '' : date("jS F, Y", strtotime($dob)) ; ?></span>
                              </li>
                              <li class="list-group-item">
                      ...
                      <div class="tab-pane" id="tabVerticalLeft12" aria-labelledby="baseVerticalLeft1-tab2">
                        <div class="card-body">
                          <?php echo form_open('admin/update/details?id='.$LoginUserDetails['id'],'novalidate');?>
                            <div class="form-body">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="controls">
                                      <input type="text" name="skype_id" placeholder="Please Add Skype ID" class="form-control" required data-validation-required-message="This field is required" value="<?php echo $LoginUserDetails['skype_id']; ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="controls">
                                      <textarea rows="5"  type="textarea" class="form-control" name="address" placeholder="House No./flat, City" required data-validation-required-message="This field is required"><?php echo $LoginUserDetails['address']; ?></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="controls">
                                      <input type="text" class="form-control" name="city" id="locality" data-validation-regex-regex="([\a-zA-Z ]+)" placeholder="City/Town/Village" required data-validation-required-message="This field is required" data-validation-regex-message="valid inputs are a-z, A-Z" value="<?php echo $LoginUserDetails['city']; ?>">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <h5>Pin Code<span class="required">*</span></h5>
                                    <div class="controls">
                                      <input type="text" id="postal_code" name="pincode" placeholder="Postal Code" class="form-control" required data-validation-regex-regex="([\da-z]+)" data-validation-regex-message="valid inputs are a-z, 0-9" data-validation-required-message="This field is required" maxlength="10" value="<?php echo $LoginUserDetails['pincode']; ?>">
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="controls">
                                      <input type="text" class="form-control" name="state" id="administrative_area_level_1" data-validation-regex-regex="([\a-zA-Z ]+)" placeholder="State*" required data-validation-required-message="This field is required" data-validation-regex-message="valid inputs are a-z, A-Z" value="<?php echo $LoginUserDetails['state']; ?>">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="controls">
                                      <input type="text" class="form-control" name="district" id="administrative_area_level_2" data-validation-regex-regex="([\a-zA-Z ]+)" placeholder="District*" required data-validation-required-message="This field is required" data-validation-regex-message="valid inputs are a-z, A-Z" value="<?php echo $LoginUserDetails['district']; ?>">
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="col-md-6">
                                      ...
                                      <select class="form-control" name="qualification" id="qualification" required data-validation-required-message="This field is required">
                                        ...
                                        <?php 
                                          ...
                                          foreach ($educationList as $value) { 
                                            if ($LoginUserDetails['qualification'] == $value) 
                                              {?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" id="dob" name="dob" value="<?php echo date('m/d/Y', strtotime($LoginUserDetails['dob'])); ?>" placeholder="Select your Birth Date " class="form-control singledate" required data-validation-required-message="This field is required">
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
                              ...
                              <div class="form-actions right">
                                ...
                                <button type="submit" name="update_admin" id="update_admin" value="submit" class="btn btn-primary">
                      ...
                      <div class="tab-pane" id="tabVerticalLeft13" aria-labelledby="baseVerticalLeft1-tab3">
                        <div class="card-body">
                          <?php echo form_open('admin/update/password?id='.$LoginUserDetails["id"],'novalidate');?>
                            <div class="form-body">
                              ...
                              <div class="col-md-7">
                                <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <input type="password" id="password" name="password" placeholder="Enter Password" class="form-control" required data-validation-required-message="This field is required" minlength="6">
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-7">
                      ...
                      <div class="tab-pane" id="tabVerticalLeft14" aria-labelledby="baseVerticalLeft1-tab4">
                        <div class="card-body">
                          <?php echo form_open_multipart('admin/update/image?id='.$LoginUserDetails["id"],'novalidate');?>
                            <img src="<?php echo base_url('uploads/').$LoginUserDetails['profile_image']; ?>" style= 'display: none;' id='profileImage'>
                            <div class="form-body">
                              ...
                              <div class="col-md-7">
                                <div class="form-group">
                                  ...
                                  <img id="newImage" src="<?php echo base_url('uploads/').$LoginUserDetails['profile_image']; ?>" alt="XYZ" style="width: 115px;padding-top: 10px;">
                                </div>
                              </div>
                              <div class="form-actions right">
