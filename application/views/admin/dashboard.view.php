...
<body class="vertical-layout vertical-compact-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-compact-menu" data-col="2-columns">
  ...
  <script src="<?php echo base_url();?>/app-assets/vendors/js/charts/gmaps.min.js" type="text/javascript"></script>
	<?php include(dirname(__FILE__)."/includes/footer.php"); ?>
	<script src="<?php echo base_url();?>/app-assets/vendors/js/charts/echarts/echarts.js" type="text/javascript"></script>
