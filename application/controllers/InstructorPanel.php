...
class InstructorPanel extends CI_Controller {
	...
	*/
	...
	public function SingleCourseStudentList()
	{
		$data['title'] = "Single Course Students";

		$data['allStudents'] = $this->instructor_model->get_single_course_students_list();
		// print_r($data['allStudents']);
		// die();
		$this->load->view('instructor/cp_students_list.view.php',$data);
	}
	...
	*/
	...
	public function SingleCourseStudentResult()
	{
		$data['title'] = "Complete Package Students";

		$data['allStudents'] = $this->instructor_model->get_single_course_students_result();
